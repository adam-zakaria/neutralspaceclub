...
nnoremap <silent>  + :exe "vertical resize -20"
nnoremap   <Nop>
...
vnoremap < <gv
vnoremap > >gv
nnoremap H :call ToggleHiddenAll()
...
set matchtime=2
set ruler
set runtimepath=~/.vim,~/.vim/plugged/jedi-vim/,~/.vim/plugged/lucius/,~/.vim/plugged/dracula/,~/.vim/plugged/awesome-vim-colorschemes/,~/.vim/plugged/supertab/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/nerdtree/,~/.vim/plugged/vim-easymotion/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/jedi-vim/after,~/.vim/plugged/dracula/after,~/.vim/plugged/awesome-vim-colorschemes/after,~/.vim/after
set scrolloff=7
set shiftwidth=4
set showmatch
set smartindent
...
set shortmess=aoO
badd +0 Code/neutralspaceclub/index.html
argglobal
silent! argdel *
edit Code/neutralspaceclub/index.html
